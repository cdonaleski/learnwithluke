...
(function () {
  ...
  const PIPS = D3.PIPS;
  const CUBE_FACES = D3.CUBE_FACES;
  const CUBE_ANGLES = D3.CUBE_ANGLES;
  ...
  /* ---------- Rendering ---------- */
  const buildCube = D3.buildCube;
  const cubeTransform = D3.cubeTransform;
